    ...
    <div class="box-content cart-item-details">
        <div class="w85 text-center mr15">
            <div class="inline-block clearfix">
                <?php echo js_anchor('<i class="fa fa-minus"></i>', array("class" => "cart-item-quantity-btn pull-left mr10 mt5", "data-action" => "minus")); ?>
                <div class="b-a w cart-item-quantity pull-left" data-quantity="<?php echo $item->quantity; ?>"><?php echo $item->quantity; ?></div>
                <?php echo js_anchor('<i class="fa fa-plus"></i>', array("class" => "cart-item-quantity-btn pull-left ml10 mt5", "data-action" => "plus")); ?>
            </div>
        </div>
    </div>
