<div class="bg-white p15 pt0 b-b">
    ...
    <?php if ($ticket_info->task_id != "0") { ?>
        ...
        <?php echo modal_anchor(get_uri("projects/task_view"), $ticket_info->task_title, array("title" => lang('task_info') . " #$ticket_info->task_id", "data-post-id" => $ticket_info->task_id, "data-modal-lg" => "1")) ?>
    <?php } ?>
</div>
