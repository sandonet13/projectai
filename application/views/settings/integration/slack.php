<div class="panel panel-default no-border clearfix mb0">
    ...
    <div class="panel-body">
        ...
        <div id="slack-details-area" class="<?php echo get_setting("enable_slack") ? "" : "hide" ?>">
            ...
            <div class="form-group">
                <label for="slack_dont_send_any_projects" class="col-md-2 col-xs-8 col-sm-4"><?php echo lang('dont_send_any_project_related_notifications_to_this_channel'); ?></label>
                <div class="col-md-10 col-xs-4 col-sm-8">
                    <?php
    ...
    <div class="panel-footer">
        ...
        <?php if (get_setting("enable_slack") && get_setting("slack_webhook_url")) { ?>
            <button id="test-slack-btn" type="button" class="btn btn-info ml15"><span class="fa fa-slack"></span> <?php echo lang('send_a_test_message'); ?></button>
        <?php } ?>
    </div>
    <?php echo form_close(); ?>
</div>
