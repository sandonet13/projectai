<div class="list-group">
    <?php foreach ($timers as $timer) { ?>
        <div  class="list-group-item"> 
            ...
            <?php } else { ?>
                <div class="pt5"> <i class="fa fa-tasks"></i> <?php echo modal_anchor(get_uri("projects/task_view"), $timer->task_title, array("title" => lang('task_info') . " #$timer->task_id", "class" => "dark", "data-post-id" => $timer->task_id, "data-modal-lg" => "1")); ?></div>
            <?php } ?>
        </div>
    <?php } ?>
</div>
