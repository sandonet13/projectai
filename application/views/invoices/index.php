<div id="page-content" class="clearfix p20">
    <div class="panel clearfix">
        <ul id="invoices-tabs" data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            <li class="title-tab"><h4 class="pl15 pt10 pr15">Petty Cash</h4></li>
...
<script type="text/javascript">
    ...
    source: '<?php echo_uri("pcash/list_data") ?>',
            ...
            order: [[0, "desc"]],
            filterDropdown: [
            {name: "status", class: "w150", options: <?php $this->load->view("pcash/invoice_statuses_dropdown"); ?>},
